      ...
      <div className="footer__social-copyright-card-wrapper">
        <article className="footer__footer-card footer-card footer-card--social">
          ...
          <div className="footer-card__social-links-wrapper">
            <a href="https://www.facebook.com" target="_blank" className="footer-card__social-link">
              <FacebookRounded
                className="footer-card__social-link-icon"
                sx={{ ...socialIconStyles }}
              />
            </a>
            <a href="https://www.instagram.com" target="_blank" className="footer-card__social-link">
              <Instagram
                className="footer-card__social-link-icon"
                sx={{ ...socialIconStyles }}
              />
            </a>
            <a href="https://www.twitter.com" target="_blank" className="footer-card__social-link">
              <Twitter
                className="footer-card__social-link-icon"
                sx={{ ...socialIconStyles }}
              />
