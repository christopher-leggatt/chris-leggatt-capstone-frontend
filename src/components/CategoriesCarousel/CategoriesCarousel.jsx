...
const CategoriesCarousel = () => {
  ...
  const categories = [
    {
      name: "Flower",
      image: "http://localhost:5050/images/flower_category.jpg",
      category_name: "flower"
    },
    {
      name: "Vaporizers",
      image: "http://localhost:5050/images/vaporizers_category.jpg",
      category_name: "vaporizers",
    },
    {
      name: "Edibles",
      image: "http://localhost:5050/images/edibles_category.jpg",
  ...
  return (
    ...
    >
      {chunkedCategories.map((chunkedCategory, index) => {
        return <CategoriesBanner key={`categoryItem_${index}`} chunkedCategory={chunkedCategory} />
})}
    </Carousel>
  );
};
